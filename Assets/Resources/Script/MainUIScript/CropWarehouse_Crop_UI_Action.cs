...
public class CropWarehouse_Crop_UI_Action : MonoBehaviour {
    ...
    {
        CropID = crop_id;
        Crop_Icon.spriteName = CropsManager.Get_Inctance().Get_CropInfo(crop_id).SpriteName;
    ...
    public void View_Sell_Crop_UI()
    {
        ...
        Sell_Crop_UI_Action.Get_Inctance().Set_Sell_Crop_UI(CropID, CropInfo.SpriteName, CropInfo.Name);
    }
}
